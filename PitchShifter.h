...
public:
    ...
    {
        //here i added this to convert from semitone range to ratio range
        newPitchRatio = std::pow(2.0, newPitchRatio / 12.0); // Perform the calculation
//        newPitchRatio = std::exp2(newPitchRatio / 12.0); //Perform the calculation slightly faster
