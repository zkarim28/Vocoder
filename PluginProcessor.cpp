...
//Here is where the slider is set up
#ifndef JucePlugin_PreferredChannelConfigurations
,state (*this, nullptr, "Params", {
    std::make_unique<juce::AudioParameterFloat> (juce::ParameterID {"Pitch", 1}, "Pitch Multiplier",
                                                 juce::NormalisableRange<float> (-12.0f, 12.0f), 0),
    std::make_unique<juce::AudioParameterFloat> (juce::ParameterID {"Formants", 1}, "Formants Control",
                                                juce::NormalisableRange<float> (0.5f, 2.0f), 1)
})
#endif
...

{
    ...
    formantParam = state.getRawParameterValue("Formants");
